...
class PodcastPackageManifestTest {
	...
	String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>\n" +
		...
		"\">\n" + "  <mp3 interview=\"" + this.interview + "\" intro=\"" + this.intro + "\"/>\n" + "</podcast>\n";
	...
	public void fromString() {
		...
		Assert.assertEquals("the description must match", manifest.getDescription(), description);
		Assert.assertFalse("the media collection must be non-null", manifest.getMedia().isEmpty());
