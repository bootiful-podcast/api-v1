...
class OldPodcastPackageManifestTest {
	...
	public void fromString() {
		var manifest = OldPodcastPackageManifest.from(xml);
		...
		Iterator<OldPodcastPackageManifest.Media> iterator = manifest.getMedia()
				.iterator();
		OldPodcastPackageManifest.Media next = iterator.next();
